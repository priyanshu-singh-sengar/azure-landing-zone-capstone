resource "azurerm_virtual_network_peering" "peering_1_to_2" {
  name                         = coalesce(var.peering_name_1_to_2, "peer-${var.vnet_1_name}-to-${var.vnet_2_name}")
...
resource "azurerm_virtual_network_peering" "peering_2_to_1" {
  name                         = coalesce(var.peering_name_2_to_1, "peer-${var.vnet_2_name}-to-${var.vnet_1_name}")
